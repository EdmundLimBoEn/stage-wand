Implement Stage Wand now. You are file owner 3. User prioritizes speed; use medium effort. Do not delegate, commit, push or change other files. Ignore CLAUDE.md. Shared files are being edited concurrently by other owners.
FROZEN CONTRACT
